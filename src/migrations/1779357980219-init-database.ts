...
export class InitDatabase1779357980219 implements MigrationInterface {
  name = 'InitDatabase1779357980219';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "analysis" ADD CONSTRAINT "FK_b2e70858ee53dcd21ea6023b8b8" FOREIGN KEY ("writingId") REFERENCES "writings"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "analysis" DROP CONSTRAINT "FK_b2e70858ee53dcd21ea6023b8b8"`,
    );
    await queryRunner.query(
